...
class EvalExp:
    ...
    def run(self, model_ref, system, benchmark, out_url, subsample = 1.0, redo_eval = False, run_id = '0', split = None, processes = -1, callbacks = None,  eval_only = False, skip_eval = False, max_error_task_retries = 0, flat_out = False, task_scores_file = "task_scores.txt"):
        ...
        with AzVllm(model_ref.model_url_to_start, model_ref.model_port, model_ref.device_id, model_ref.max_n_images, model_ref.dtype, model_ref.enforce_eager, model_ref.use_external_endpoint) as vllm:
            ...
            if skip_eval:
                mlflow.log_param('skip_eval', True)
            ...
            results = run_eval_multiple_examples_with_progress(examples, processes, output_folder, redo_eval, system, benchmark, callback, eval_only, skip_eval, max_error_task_retries)
